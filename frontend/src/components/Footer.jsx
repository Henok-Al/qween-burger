...
const Footer = () => {
  ...
  const translations = {
    en: {
      ...
      address: 'Kebele 10, Next to Total Gas Station, Assela, Ethiopia',
      hours: 'Mon-Sun: 8AM - 10PM',
      copyright: '© 2024 Queen Burger. All rights reserved.',
    ...
    am: {
      ...
      contactUs: 'እኛን ያግኙ',
      address: 'ቀበሌ 10፣ ከቶታል ነዳጅ ማደያ ቀጥሎ፣ አሰላ፣ ኢትዮጵያ',
      hours: 'ሰኞ-እሑድ: 8AM - 10PM',
      copyright: '© 2024 Queen Burger. መብቶች ሁሉ የተጠበቁ ናቸው።',
    ...
    om: {
      ...
      address: 'Kebele 10, Boba Total Gas Station Biratti, Asallaa, Itoophiyaa',
      hours: 'Wiixata-Dilbata: 8AM - 10PM',
      copyright: '© 2024 Queen Burger. Haqa hundi eegama.',
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">Queen Burger</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 mt-4 text-gray-400">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="tel:+251911270496" className="hover:text-white transition-colors">+251 911 270 496</a>
              </li>
              <li className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:queenburger@gmail.com" className="hover:text-white transition-colors">queenburger@gmail.com</a>
              </li>
              <li className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-primary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
