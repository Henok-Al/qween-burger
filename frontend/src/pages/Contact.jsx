    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-orange-50/30 to-red-50/30">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 py-20 text-center">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-white/20 backdrop-blur-sm rounded-full mb-6 animate-bounce p-3">
            <img src="/logo.png" alt="Queen Burger Logo" className="w-full h-full object-contain drop-shadow-lg" />
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-12">
          ...
          <div className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 border border-gray-100 hover:-translate-y-2">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              {t('contactAddress') || 'Kebele 10, Next to Total Gas Station'}<br />
              {t('contactAddress2') || 'Assela, Ethiopia'}
            </p>
          </div>
          ...
          <div className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 border border-gray-100 hover:-translate-y-2">
            ...
            <p className="text-gray-600 text-sm">
              <a href="tel:+251911270496" className="hover:text-primary transition-colors">+251 911 270 496</a>
            </p>
          </div>
          ...
          <div className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 border border-gray-100 hover:-translate-y-2">
            ...
            <p className="text-gray-600 text-sm">
              <a href="mailto:queenburger@gmail.com" className="hover:text-primary transition-colors">queenburger@gmail.com</a>
            </p>
          </div>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      id="name"
                      {...register('name')}
                      className={`w-full px-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200 bg-gray-50/50 ${errors.name ? 'border-red-500' : 'border-gray-200'
                        }`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      id="email"
                      {...register('email')}
                      className={`w-full px-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200 bg-gray-50/50 ${errors.email ? 'border-red-500' : 'border-gray-200'
                        }`}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      id="phone"
                      {...register('phone')}
                      className={`w-full px-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200 bg-gray-50/50 ${errors.phone ? 'border-red-500' : 'border-gray-200'
                        }`}
                  ...
                  <div>
                    ...
                    <select
                      id="subject"
                      {...register('subject')}
                      className={`w-full px-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200 bg-gray-50/50 ${errors.subject ? 'border-red-500' : 'border-gray-200'
                        }`}
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    {...register('message')}
                    rows={5}
                    className={`w-full px-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200 resize-none bg-gray-50/50 ${errors.message ? 'border-red-500' : 'border-gray-200'
                      }`}
            ...
            <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
              <div className="p-4 bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Assela, Ethiopia</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-4 bg-gray-50 border-t border-gray-200 flex flex-wrap gap-3 justify-between items-center">
                <div className="flex items-center space-x-2 text-gray-600 text-sm">
                  ...
                  <span>7.95° N, 39.13° E</span>
                </div>
                <a
                  href="https://www.google.com/maps/search/?api=1&query=7.95,39.13"
                  target="_blank"
